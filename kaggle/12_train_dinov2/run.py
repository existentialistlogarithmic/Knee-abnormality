...
RUN_FOLD = 0
RUN_EPOCHS = 16
RUN_BATCH = 6            # ViT-S/14 at 196px is heavier per image than resnet34
ACCUM_STEPS = 3          # 6 x 3 = effective batch 18, near the 16 that worked
RUN_LR = 1e-4            # ViTs want a lower LR than convnets; DINOv2 features
                         # are strong already, so this is fine-tuning not training
