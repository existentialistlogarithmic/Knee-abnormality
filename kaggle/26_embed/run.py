...
def main() -> int:
    ...
    for index, study in enumerate(studies):
        ...
        planes, slices = volume.shape[0], volume.shape[1]
        flat = torch.from_numpy(volume).reshape(planes * slices, 1,
